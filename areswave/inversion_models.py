...
# PATHS / CONFIG
# ============================================================
DATA_DIR = "/home/lyara/areswave/SAC1_Copy/"
CSV_FILE = "data/arrivals_S1094b.csv"
...
def plot_fig3_ab(suite: Sequence[SuiteModel], results_df: pd.DataFrame, output_dir: str) -> Tuple[str, str]:
    ...
    out_a = os.path.join(output_dir, "fig3A_vp_profiles_pmisfit_S0345a.png")
    plt.tight_layout()
    ...
    out_b = os.path.join(output_dir, "fig3B_vs_profiles_smisfit_S0345a.png")
    plt.tight_layout()
...
def plot_fig3_cde(results_df: pd.DataFrame, output_dir: str) -> str:
    ...
    out = os.path.join(output_dir, "fig3CDE_misfit_vs_depth_S0345a.png")
    plt.tight_layout()
...
def plot_mtz4_scatter(results_df: pd.DataFrame, output_dir: str) -> str:
    ...
    out = os.path.join(output_dir, "fig_mtz4_scatter_misfit_vs_depth_S0345a.png")
    plt.tight_layout()
    plt.savefig(out, dpi=300)
    plt.close(fig)
    return out
...
def plot_mtz4_paperlike(suite: Sequence[SuiteModel], results_df: pd.DataFrame, output_dir: str) -> str:
    ...
    out = os.path.join(output_dir, "vp_vs_paperlike_mtz4_bestmodel_S0345a.png")
    plt.tight_layout()
    plt.savefig(out, dpi=300)
    plt.close(fig)
    return out
...
def main(models_dir: str = MODELS_DIR):
    ...
    out_csv = os.path.join(OUTPUT_DIR, "pnas_equivalent_suite_results_S0345a.csv")
    ...
    summary_txt = os.path.join(OUTPUT_DIR, "best_model_summary_S0345a.txt")
