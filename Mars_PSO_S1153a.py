...
event_id = 'S1153a_mqs2022dulj_tayak'
latitude, longitude, distance, depth = -68.0, -161.5, 84.8, 30
magnitude = 3.0
...
sac_files = [
    os.path.join(sac_folder_path, 'S1153a_trlq_denois03.R.sac'),
    os.path.join(sac_folder_path, 'S1153a_trlq_denois04.T.sac'),
    os.path.join(sac_folder_path, 'S1153a_trlq_denois05.Z.sac')
]
...
# Configuration: PSO
bounds = (np.array([18, 0, 0, -180]), np.array([50, 360, 90, 180]))
