...
event_id = 'mqs2021sijy_tayak'
latitude, longitude, distance, depth = 38.1, -79.9, 128.3, 30
magnitude = 4.1
time_p = UTCDateTime("2021-09-18T18:01:47")
time_s = UTCDateTime("2021-09-18T18:14:08")
centroid_time = UTCDateTime("2021-09-18T17:46:20")
...
sac_files = [
    os.path.join(sac_folder_path, 'S1000a_trlq_denois03.R.sac'),
    os.path.join(sac_folder_path, 'S1000a_trlq_denois04.T.sac'),
    os.path.join(sac_folder_path, 'S1000a_trlq_denois05.Z.sac')
]
...
# Configuration: PSO
bounds = (np.array([23, 0, 0, -180]), np.array([86, 360, 90, 180]))
