...
event_id = 'S1415a_mqs2022wrzi_tayak'
latitude, longitude, distance, depth = 4.5024, 135.6234, 88.2, 30
magnitude = 3.3
time_p = UTCDateTime("2022-11-19T21:56:03")
time_s = UTCDateTime("2022-11-19T22:03:29")
centroid_time = UTCDateTime("2022-11-19T21:53:34")
...
sac_files = [
    os.path.join(sac_folder_path, 'S1415a_trlq_denois03.R.sac'),
    os.path.join(sac_folder_path, 'S1415a_trlq_denois04.T.sac'),
    os.path.join(sac_folder_path, 'S1415a_trlq_denois05.Z.sac')
]
if not all(os.path.exists(f) for f in sac_files):
    raise FileNotFoundError("Um ou mais arquivos SAC não foram encontrados.")
...
# Configuration: PSO
bounds = (np.array([15, 0, 0, -180]), np.array([66, 360, 90, 180]))
...
print(f"Processed. Resultads and plots saved in: {fig_dir}")