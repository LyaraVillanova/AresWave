...
event_id = 'S0152a_mqs2019jptm_tayak'
latitude, longitude, distance, depth = -43.7, -112.6, 98.0, 30
magnitude = 3.8
time_p = UTCDateTime("2019-05-02T07:29:25")
time_s = UTCDateTime("2019-05-02T07:34:39")
centroid_time = UTCDateTime("2019-05-02T07:19:49")
...
sac_files = [
    os.path.join(sac_folder_path, 'S0152a_trlq_denois03.R.sac'),
    os.path.join(sac_folder_path, 'S0152a_trlq_denois04.T.sac'),
    os.path.join(sac_folder_path, 'S0152a_trlq_denois05.Z.sac')]
...
for sac_file in sac_files:
    ...
    tr.trim(starttime=time_p - 10, endtime=time_p + 400)
    stream += tr
...
# Configuration: PSO
bounds = (np.array([11, 0, 0, -180]), np.array([37, 360, 90, 180]))
