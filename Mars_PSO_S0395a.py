...
event_id = 'mqs2020akwb_tayak'
latitude, longitude, distance, depth = -50.7, -124.4, 90.6, 30
magnitude = 3.1
time_p = UTCDateTime("2020-01-06T22:32:46")
time_s = UTCDateTime("2020-01-06T22:36:07")
centroid_time = UTCDateTime("2020-01-06T22:28:45")
...
sac_files = [
    os.path.join(sac_folder_path, 'S0395a_trlq_denois03.R.sac'),
    os.path.join(sac_folder_path, 'S0395a_trlq_denois04.T.sac'),
    os.path.join(sac_folder_path, 'S0395a_trlq_denois05.Z.sac')
]
...
# Configuration: PSO
bounds = (np.array([6, 0, 0, -180]), np.array([24, 360, 90, 180]))
