...
from dsmpy import dsm_Mars, rootdsm_psv, rootdsm_sh
from dsmpy.dataset_Mars import Dataset
from dsmpy.seismicmodel_Mars import SeismicModel
from dsmpy.dsm_Mars import PyDSMInputFile
...
def main(path):
    ...
    # run pydsm
    start_time = time.time()
    outputs = dsm_Mars.compute_dataset_parallel(dataset, seismic_model,
                                           tlen,
                                           nspc,
                                           sampling_hz,
                                           mode=mode,
