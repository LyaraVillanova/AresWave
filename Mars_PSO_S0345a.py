...
event_id = 'mqs2019wltj_tayak'
latitude, longitude, distance, depth = -66.0, 57.8, 91.5, 30
magnitude = 3.2
time_p = UTCDateTime("2019-11-16T12:07:01")
time_s = UTCDateTime("2019-11-16T12:10:40")
centroid_time = UTCDateTime("2019-11-16T12:03:41")
...
sac_files = [
    os.path.join(sac_folder_path, 'S0345a_trlq_denois03.R.sac'),
    os.path.join(sac_folder_path, 'S0345a_trlq_denois04.T.sac'),
    os.path.join(sac_folder_path, 'S0345a_trlq_denois05.Z.sac')
]
...
# Configuration: PSO
bounds = (np.array([7, 0, 0, -180]), np.array([26, 360, 90, 180]))
