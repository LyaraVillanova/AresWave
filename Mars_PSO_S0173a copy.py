...
event_id = 'S0173a_tayak'
latitude, longitude, distance, depth = 4.90, 165.73, 30.0, 30
magnitude = 3.7
time_p = UTCDateTime("2019-05-23T02:22:59")
time_s = UTCDateTime("2019-05-23T02:25:51")
centroid_time = UTCDateTime("2019-05-23 02:19:09")
...
sac_files = [
    os.path.join(sac_folder_path, 'S0173a_enztrlq_denois03.R.sac'),
    os.path.join(sac_folder_path, 'S0173a_enztrlq_denois04.T.sac'),
    os.path.join(sac_folder_path, 'S0173a_enztrlq_denois05.Z.sac')
]
