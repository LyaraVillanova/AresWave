...
event_id = 'S0133a_mqs2019hdxw_tayak'
latitude, longitude, distance, depth = -34, -140.7, 88.5, 30
magnitude = 3.1
time_p = UTCDateTime("2019-04-12T18:12:25")
time_s = UTCDateTime("2019-04-12T18:18:05")
centroid_time = UTCDateTime("2019-04-12 18:10:36")
...
sac_files = [
    os.path.join(sac_folder_path, 'S0133a_trlq_denois03.R.sac'),
    os.path.join(sac_folder_path, 'S0133a_trlq_denois04.T.sac'),
    os.path.join(sac_folder_path, 'S0133a_trlq_denois05.Z.sac')]
...
# Configuration: PSO
bounds = (np.array([11, 0, 0, -180]), np.array([43, 360, 90, 180]))
