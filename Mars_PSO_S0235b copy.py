...
event_id = 'S0235b_tayak'
latitude, longitude, distance, depth = 10.18, 164.06, 28.7, 30
magnitude = 3.7
time_p = UTCDateTime("2019-07-26T12:19:24")
time_s = UTCDateTime("2019-07-26T12:22:10")
centroid_time = UTCDateTime("2019-07-26 12:15:38")
...
sac_files = [
    os.path.join(sac_folder_path, 'S0235b_enztrlq_denois03.R.sac'),
    os.path.join(sac_folder_path, 'S0235b_enztrlq_denois04.T.sac'),
    os.path.join(sac_folder_path, 'S0235b_enztrlq_denois05.Z.sac')
]
...
# Configuration: PSO
bounds = (np.array([5, 0, 0, -180]), np.array([21, 360, 90, 180]))
