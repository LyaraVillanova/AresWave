...
event_id = 'mqs2021qpls_tayak'
latitude, longitude, distance, depth = -22.8, -100.7, 146.3, 30
magnitude = 4.3
time_p = UTCDateTime("2021-08-25T03:48:20")
time_s = UTCDateTime("2021-08-25T04:00:47")
centroid_time = UTCDateTime("2021-08-25T03:32:20")
...
sac_files = [
    os.path.join(sac_folder_path, 'S0976a_trlq_denois03.R.sac'),
    os.path.join(sac_folder_path, 'S0976a_trlq_denois04.T.sac'),
    os.path.join(sac_folder_path, 'S0976a_trlq_denois05.Z.sac')
]
...
for sac_file in sac_files:
    ...
    tr.trim(starttime=time_p - 10, endtime=time_p + 800)
    stream += tr
...
# Configuration: PSO
bounds = (np.array([26, 0, 0, -180]), np.array([92, 360, 90, 180]))
