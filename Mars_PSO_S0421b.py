...
event_id = 'mqs2020chtn_tayak'
latitude, longitude, distance, depth = -7.4, -142.2, 93.7, 30
magnitude = 3.3
time_p = UTCDateTime("2020-02-02T16:55:38")
time_s = UTCDateTime("2020-02-02T17:01:12")
centroid_time = UTCDateTime("2020-02-02T16:53:32")
...
sac_files = [
    os.path.join(sac_folder_path, 'S0421b_trlq_denois03.R.sac'),
    os.path.join(sac_folder_path, 'S0421b_trlq_denois04.T.sac'),
    os.path.join(sac_folder_path, 'S0421b_trlq_denois05.Z.sac')
]
...
# Configuration: PSO
bounds = (np.array([10, 0, 0, -180]), np.array([40, 360, 90, 180]))
