...
event_id = 'S1094b_mqs2021zdzn_tayak'
latitude, longitude, distance, depth = 42.5728, -173.9194, 59.7, 0
magnitude = 4.0
time_p = UTCDateTime("2021-12-24T22:45:13")
time_s = UTCDateTime("2021-12-24T22:50:47")
...
sac_files = [
    os.path.join(sac_folder_path, 'S1094b_enztrlq_denois03.R.sac'),
    os.path.join(sac_folder_path, 'S1094b_enztrlq_denois04.T.sac'),
    os.path.join(sac_folder_path, 'S1094b_enztrlq_denois05.Z.sac')
]
...
# Configuration: PSO
bounds = (np.array([10, 0, 0, -180]), np.array([38, 360, 90, 180]))
