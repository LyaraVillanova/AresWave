...
event_id = 'mqs2019pxdv_tayak'
latitude, longitude, distance, depth = -42.3, -114.1, 89.5, 30
magnitude = 2.7
time_p = UTCDateTime("2019-08-15T03:02:12")
time_s = UTCDateTime("2019-08-15T03:06:34")
centroid_time = UTCDateTime("2019-08-15T03:06:01")
...
sac_files = [
    os.path.join(sac_folder_path, 'S0254b_trlq_denois03.R.sac'),
    os.path.join(sac_folder_path, 'S0254b_trlq_denois04.T.sac'),
    os.path.join(sac_folder_path, 'S0254b_trlq_denois05.Z.sac')
]
...
# Configuration: PSO
bounds = (np.array([8, 0, 0, -180]), np.array([31, 360, 90, 180]))
