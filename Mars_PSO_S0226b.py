...
event_id = 'S0226a_mqs2019nwjf_tayak'
latitude, longitude, distance, depth = -38.1, -122.9, 94.1, 30
magnitude = 3.2
time_p = UTCDateTime("2019-07-17T05:44:00")
time_s = UTCDateTime("2019-07-17T05:49:17")
centroid_time = UTCDateTime("2019-07-17T05:40:01")
...
sac_files = [
    os.path.join(sac_folder_path, 'S0226b_trlq_denois03.R.sac'),
    os.path.join(sac_folder_path, 'S0226b_trlq_denois04.T.sac'),
    os.path.join(sac_folder_path, 'S0226b_trlq_denois05.Z.sac')
]
...
# Configuration: PSO
bounds = (np.array([10, 0, 0, -180]), np.array([37, 360, 90, 180]))
