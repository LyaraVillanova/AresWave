...
event_id = 'S0167a_mqs2019jptm_tayak'
latitude, longitude, distance, depth = -13, -143.7, 95.3, 30
magnitude = 3.8
time_p = UTCDateTime("2019-05-17T16:46:43")
time_s = UTCDateTime("2019-05-17T16:52:08")
centroid_time = UTCDateTime("2019-05-17 16:43:26")
...
sac_files = [
    os.path.join(sac_folder_path, 'S0167a_trlq_denois03.R.sac'),
    os.path.join(sac_folder_path, 'S0167a_trlq_denois04.T.sac'),
    os.path.join(sac_folder_path, 'S0167a_trlq_denois05.Z.sac')]
...
# Configuration: PSO
bounds = (np.array([9, 0, 0, -180]), np.array([39, 360, 90, 180]))
